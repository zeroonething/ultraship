...
| --- | --- | --- | --- | --- |
| ultraship | RELEASED | 0.5.1 | independent-product | One developer takes one product from idea to an immutable release record, entirely in local canonical state. |
