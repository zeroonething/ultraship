...
// What a workspace created by this release does about committing its own work.
// New workspaces commit at checkpoints; a workspace carried over from 1.x is
// pinned to 'off' by migrate, so the 2.0 default never surprises an existing one.
export const DEFAULT_COMMIT_POLICY = 'checkpoint';
