...
export function migrate(root) {
  ...
  if (!hadLegacy) return { migrated: false, reason: 'already per-product', product: null, lifecycle: null, framework_version, schema_version };
  ...
  return { migrated: true, product, lifecycle, framework_version, schema_version };
}
